...
def run_apply_sort():
    ...
    # Lese die Sorting_Suggestions
    rows = sheet_mgr.read_all_rows("Sorting_Suggestions")
    ...
    for row in rows:
        ...
        if action_mode == "SAFE" and target_folder_id and move_result == "PENDING":
            row_idx = rows.index(row) + 1 # 1-based index für sheets
            ...
            try:
                ...
                # Update das Move Result im Sheet, damit es nicht noch mal angefasst wird
