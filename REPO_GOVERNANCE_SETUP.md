...
- `deploy-shell-check` — validates `deploy.sh` shell syntax via `bash -n` and `shellcheck`. Required gate ensuring the production deploy script is syntactically correct before merge.
