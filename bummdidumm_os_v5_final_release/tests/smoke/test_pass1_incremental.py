...
class TestPass1Incremental(unittest.TestCase):
    def test_incremental_metadata_and_skip(self):
        ...
        sha_map = {}
        main_pass1._process_file_batch(drive_service, drive_mgr, state, [f1], known_file_details, sha_map, True, "")
        ...
        main_pass1._process_file_batch(drive_service, drive_mgr, state, [f1_moved], known_file_details, sha_map, False, "")
        ...
        main_pass1.determine_change_type = lambda *args: "NEW"
        main_pass1._process_file_batch(drive_service, drive_mgr, state, [f_large], known_file_details, sha_map, False, "")
        ...
        main_pass1.determine_change_type = lambda *args: "UNCHANGED_CONTENT_METADATA_ONLY"
        main_pass1._process_file_batch(drive_service, drive_mgr, state, [f_large_again], known_file_details, sha_map, False, "")
        self.assertEqual(known_file_details["2"]["sha"], "HASH_SKIPPED_SIZE")
