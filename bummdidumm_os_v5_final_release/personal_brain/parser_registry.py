...
class ParserRegistry:
    def __init__(self) -> None:
        self.parsers: list[BaseParser] = [
            ...
            ChatGPTExportParser(), ClaudeExportParser(), GeminiChatExportParser(), PerplexityExportParser(),
            NotebookLMArtifactsParser(), PromptBundleParser(), LlmMarkdownBundleParser(),
            LlmJsonTranscriptParser(), LlmHtmlExportParser(),
